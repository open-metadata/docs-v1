...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/metadata/alationsink/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.11/connectors/alationsink/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/alationsink/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/alationsink/service-connection.png",
} 
/%}
