...
{% image
src="/images/v1.11/connectors/ranger/tag-naming-example.png"
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.11/connectors/ranger/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/ranger/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/ranger/service-connection.png",
} 
/%}
## Troubleshooting
