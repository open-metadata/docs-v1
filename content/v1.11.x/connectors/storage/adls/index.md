...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/storage/adls/yaml"} /%}
...
{% image
  src="/images/v1.11/connectors/adls/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.11/connectors/adls/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.11/connectors/adls/service-connection.png"
