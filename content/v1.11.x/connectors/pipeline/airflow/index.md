...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/airflow/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Airflow", 
    selectServicePath: "/images/v1.11/connectors/airflow/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/airflow/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/airflow/service-connection.png",
} 
/%}
