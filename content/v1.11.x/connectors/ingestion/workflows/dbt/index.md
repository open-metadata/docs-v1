...
{% image
  src="/images/v1.11/features/ingestion/workflows/dbt/dbt-features/dbt-lineage.webp"
  alt="dbt-lineage"
  caption="dbt Lineage"
 /%}
...
{% image
  src="/images/v1.11/features/ingestion/workflows/dbt/dbt-features/dbt-tags.png"
  alt="dbt-tags"
  caption="dbt Tags"
 /%}
...
{% image
  src="/images/v1.11/features/ingestion/workflows/dbt/dbt-features/dbt-owner.webp"
  alt="dbt-owner"
  caption="dbt Owner"
 /%}
...
{% image
  src="/images/v1.11/features/ingestion/workflows/dbt/dbt-features/dbt-descriptions.webp"
...
{% image
  src="/images/v1.11/features/ingestion/workflows/dbt/dbt-features/dbt-tests.webp"
  alt="dbt-tests"
  caption="dbt Tests"
 /%}
...
{% image
  src="/images/v1.11/features/ingestion/workflows/dbt/dbt-features/dbt-tier.png"
  alt="dbt-tiers"
  caption="dbt Tiers"
 /%}
...
{% image
  src="/images/v1.11/features/ingestion/workflows/dbt/dbt-features/dbt-glossary.png"
  alt="dbt-glossary"
