...
{% image
  src="/images/v1.11/features/ingestion/workflows/lineage/table-entity-page.png"
...
{% image
  src="/images/v1.11/features/ingestion/workflows/lineage/add-ingestion.png"
  alt="add-ingestion"
...
{% image
  src="/images/v1.11/features/ingestion/workflows/lineage/configure-lineage-ingestion.png"
...
{% image
  src="/images/v1.11/features/ingestion/workflows/lineage/scheule-and-deploy.png"
