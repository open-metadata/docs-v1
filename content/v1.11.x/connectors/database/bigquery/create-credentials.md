...
{% image
src="/images/v1.11/connectors/bigquery/create-role-1.png"
...
{% image
src="/images/v1.11/connectors/bigquery/create-role-2.png"
...
{% image
src="/images/v1.11/connectors/bigquery/create-role-3.png"
alt="Create Role"
caption="Create Role" /%}
...
{% image
src="/images/v1.11/connectors/bigquery/create-role-4.png"
alt="Add Permissions"
...
{% image
src="/images/v1.11/connectors/bigquery/create-role-5.png"
alt="Add Permissions"
caption="Add Permissions" /%}
...
{% image
src="/images/v1.11/connectors/bigquery/bq-service-account-search.png"
...
{% image
src="/images/v1.11/connectors/bigquery/bq-create-service-account.png"
...
{% image
src="/images/v1.11/connectors/bigquery/bq-create-service-account-1.png"
alt="Create Service Accounts"
caption="Create Service Accounts" /%}
...
{% image
src="/images/v1.11/connectors/bigquery/bq-service-account-grant-role.png"
...
{% image
src="/images/v1.11/connectors/bigquery/bq-service-account-manage-keys.png"
...
{% image
src="/images/v1.11/connectors/bigquery/bq-create-service-account-key.png"
alt="Create New Key"
caption="Create New Key" /%}

{% image
src="/images/v1.11/connectors/bigquery/bq-create-key-modal.png"
