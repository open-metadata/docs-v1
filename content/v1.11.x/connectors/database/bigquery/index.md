...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/bigquery/yaml"} /%}
...
{% partial
  ...
  variables={
    connector: "BigQuery",
    selectServicePath: "/images/v1.11/connectors/bigquery/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/bigquery/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/bigquery/service-connection.png",
  }
/%}
...
{% collateContent %}
{% partial file="/v1.11/connectors/database/bigquery/reverse-metadata.md" /%}
{% /collateContent %}
