...
{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "synapse"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "synapse"} /%}
