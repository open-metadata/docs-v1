...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/timescale/yaml"} /%}
...
{% partial
  ...
  variables={
    ...
    selectServicePath: "/images/v1.11/connectors/timescale/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/timescale/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/timescale/service-connection.png",
}
/%}
...
{% collateContent %}
{% partial file="/v1.11/connectors/database/timescale/reverse-metadata.md" /%}
{% /collateContent %}
