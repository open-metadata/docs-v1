...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/mysql/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "MySQL", 
    selectServicePath: "/images/v1.11/connectors/mysql/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/mysql/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/mysql/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.11/connectors/database/mysql/reverse-metadata.md" /%}
{% /collateContent %}
