...
{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "presto"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "presto"} /%}
