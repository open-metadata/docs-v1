...
{% partial file="/v1.11/connectors/yaml/lineage.md" variables={connector: "pinotdb"} /%}

{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "pinotdb"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "pinotdb"} /%}
