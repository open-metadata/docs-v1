...
{% partial file="/v1.11/connectors/yaml/common/aws-config-def.md" /%}
...
{% partial file="/v1.11/connectors/yaml/common/aws-config.md" /%}
...
{% partial file="/v1.11/connectors/yaml/query-usage.md" variables={connector: "athena"} /%}

{% partial file="/v1.11/connectors/yaml/lineage.md" variables={connector: "athena"} /%}

{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "athena"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "athena"} /%}
