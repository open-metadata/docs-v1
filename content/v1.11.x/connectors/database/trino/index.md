...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/trino/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Trino", 
    selectServicePath: "/images/v1.11/connectors/trino/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/trino/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/trino/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.11/connectors/database/trino/reverse-metadata.md" /%}
{% /collateContent %}
