...
{% partial file="/v1.11/connectors/yaml/lineage.md" variables={connector: "impala"} /%}

{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "impala"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "impala"} /%}
