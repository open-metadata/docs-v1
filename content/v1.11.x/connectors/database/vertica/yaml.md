...
{% partial file="/v1.11/connectors/yaml/lineage.md" variables={connector: "vertica"} /%}

{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "vertica"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "vertica"} /%}
