...
{% image
  src="/images/v1.11/features/ingestion/workflows/data-quality/add-test-case.png"
...
{% image
  src="/images/v1.11/features/ingestion/workflows/data-quality/add-test-defintion.png"
  alt="Write your first test"
  caption="Write your first test"
 /%}
...
{% image
  src="/images/v1.11/features/ingestion/workflows/data-quality/add-ingestion.png"
  alt="Create an ingestion pipeline"
  caption="Create an ingestion pipeline"
 /%}

{% image
  src="/images/v1.11/features/ingestion/workflows/data-quality/ingestion-page.png"
