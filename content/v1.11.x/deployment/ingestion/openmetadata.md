...
{% image
  src="/images/v1.11/deployment/ingestion/openmetadata/om-orchestration.png"
...
- The supported Airflow versions for OpenMetadata include 2.3, 2.4, 2.5, 2.6, and 2.7. Starting from OpenMetadata release 1.11.x, Airflow version 3.1.5 is also supported. Specifically, OpenMetadata 1.5 supports Airflow 2.9, 1.6.4 supports Airflow 2.9.3, 1.6.5 supports Airflow 2.10.5. Ensure that your Airflow version aligns with your OpenMetadata deployment for optimal performance.
{% /note %}
