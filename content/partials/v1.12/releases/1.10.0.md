...
We’re also bringing improvements to the Ingestion Runners UI, helping users identify versions for both the runner server and ingestion configurations. The rest of the UX remains the same.
