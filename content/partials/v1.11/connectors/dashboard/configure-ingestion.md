...
{% image
  src="/images/v1.11/connectors/configure-metadata-ingestion-dashboard.png"
...
- **Db Service Prefixes (Optional)**: Enter the name of Database Service which is already ingested in OpenMetadata to create lineage between dashboards and database tables.
