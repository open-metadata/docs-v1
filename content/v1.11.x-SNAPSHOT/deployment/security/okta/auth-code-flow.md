...
{% image src="/images/v1.11/deployment/security/okta/okta-auth-code-1.png" alt="configuring-the-app" /%}
...
- Click **Save**.
{% image src="/images/v1.11/deployment/security/okta/okta-auth-code-2.png" alt="general-settings-click-save" /%}

- The app is now configured.
{% image src="/images/v1.11/deployment/security/okta/okta-auth-code-3.1.png" alt="app-is-configured" /%}
{% image src="/images/v1.11/deployment/security/okta/okta-auth-code-3.2.png" alt="app-is-configured" /%}
