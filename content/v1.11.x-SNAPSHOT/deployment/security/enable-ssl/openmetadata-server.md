...
{% image src="/images/v1.11/deployment/security/enable-ssl/openmetadata-server/keystore-1.png" alt="keystore" /%}
...
{% image src="/images/v1.11/deployment/security/enable-ssl/openmetadata-server/keystore-2.png" alt="keystore" /%}
...
{% image src="/images/v1.11/deployment/security/enable-ssl/openmetadata-server/browser.png" alt="browser" /%}
...
{% image src="/images/v1.11/deployment/security/enable-ssl/openmetadata-server/import-1.png" alt="import" /%}

Double-click on `localhost`:

{% image src="/images/v1.11/deployment/security/enable-ssl/openmetadata-server/import-2.png" alt="import" /%}


Click on `Trust` to open and set `Always Trust`:

{% image src="/images/v1.11/deployment/security/enable-ssl/openmetadata-server/import-3.png" alt="import" /%}
