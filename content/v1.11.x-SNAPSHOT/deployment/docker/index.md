...
{% image src="/images/v1.11/deployment/docker/om_docker_architecture.png" alt="Docker Deployment Architecture" /%}
...
{% partial file="/v1.11/deployment/configure-external-orchestrator-for-ingestion-service.md" /%}
...
```bash
wget https://github.com/open-metadata/OpenMetadata/releases/download/1.10.11-release/docker-compose-openmetadata.yml
```
...
{% partial file="/v1.11/deployment/postgresql-issue-permission-denied-extension-pgcrypto.md" /%}
