...
{% image 
src="/images/v1.11/deployment/security/auth0/create-account-1.png" 
alt="create-account" /%}

- Provide the Tenant Domain, select the region and click on Create Account.

{% image 
src="/images/v1.11/deployment/security/auth0/create-account-2.png" 
alt="create-account" /%}

- Once done, you will land on the dashboard page.

{% image
src="/images/v1.11/deployment/security/auth0/create-account-3.png" 
alt="create-account" /%}
...
{% image 
src="/images/v1.11/deployment/security/auth0/create-new-app-1.png" 
alt="create-app" /%}

- Click on `Create Application`.

{% image 
src="/images/v1.11/deployment/security/auth0/create-new-app-2.png" 
alt="create-app" /%}
...
{% image 
src="/images/v1.11/deployment/security/auth0/create-new-app-3.png" 
alt="create-app" /%}
...
{% image 
src="/images/v1.11/deployment/security/auth0/credentials.png" 
alt="credentials" /%}
