...
{% image src="/images/v1.11/deployment/security/azure/create-app-1.png" alt="create-app" /%} 

- Click on `New Registration`. This step is for registering the OpenMetadata UI.

{% image src="/images/v1.11/deployment/security/azure/create-app-2.png" alt="create-app" /%}
...
{% image src="/images/v1.11/deployment/security/azure/create-app-3.png" alt="create-app" /%}

### Step 3: Where to Find the Credentials

- The `Client ID` and the `Tenant ID` are displayed in the Overview section of the registered application.

{% image src="/images/v1.11/deployment/security/azure/where-to-find-credentials.png" alt="create-app" /%}
