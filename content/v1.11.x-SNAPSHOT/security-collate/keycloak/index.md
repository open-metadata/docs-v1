...
{% image src="/images/v1.11/deployment/security/keycloak/1-login-page.png" alt="login-page" /%}
...
{% image src="/images/v1.11/deployment/security/keycloak/2-change-realm.png" alt="change-realm" /%}
...
{% image src="/images/v1.11/deployment/security/keycloak/3-add-client.png" alt="add-client" /%}
...
{% image src="/images/v1.11/deployment/security/keycloak/4-edit-settings-client.png" alt="edit-settings-client" /%}
...
{% image src="/images/v1.11/deployment/security/keycloak/5-edit-settings-url.png" alt="edit-settings-url.png" /%}
...
{% image src="/images/v1.11/deployment/security/keycloak/6-client-credentials.png" alt="client-credentials" /%}
