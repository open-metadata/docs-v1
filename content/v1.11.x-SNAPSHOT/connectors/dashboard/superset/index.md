...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/superset/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Superset", 
    selectServicePath: "/images/v1.11/connectors/superset/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/superset/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/superset/service-connection.png",
} 
/%}
...
1. To establish secure connections between OpenMetadata and Superset, navigate to the `Advanced Config` section. We need to update the `Certificate Path` and ensure that the certificates are accessible from the Airflow Server.
  ...
  {% image
  src="/images/v1.11/connectors/ssl_superset.png"
...
{% image
  src="/images/v1.11/connectors/ssl_superset_mysql.png"
...
{% image
  src="/images/v1.11/connectors/ssl_superset_postgres.png"
