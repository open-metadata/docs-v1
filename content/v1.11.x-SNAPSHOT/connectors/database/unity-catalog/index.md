...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/unity-catalog/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.11/connectors/unitycatalog/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/unitycatalog/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/unitycatalog/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.11/connectors/database/unitycatalog/reverse-metadata.md" /%}
{% /collateContent %}
