...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/snowflake/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Snowflake", 
    selectServicePath: "/images/v1.11/connectors/snowflake/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/snowflake/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/snowflake/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.11/connectors/database/snowflake/reverse-metadata.md" /%}
{% /collateContent %}
