...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/impala/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Impala", 
    selectServicePath: "/images/v1.11/connectors/impala/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/impala/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/impala/service-connection.png",
} 
/%}
...
{% image
  src="/images/v1.11/connectors/ssl_Impala.png"
