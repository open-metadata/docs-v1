...
{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "oracle"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "oracle"} /%}

{% partial file="/v1.11/connectors/yaml/data-quality.md" /%}

{% partial file="/v1.11/connectors/yaml/lineage.md" variables={connector: "oracle"} /%}
