...
{% partial file="/v1.11/connectors/yaml/lineage.md" variables={connector: "teradata"} /%}

{% partial file="/v1.11/connectors/yaml/data-profiler.md" variables={connector: "teradata"} /%}

{% partial file="/v1.11/connectors/yaml/auto-classification.md" variables={connector: "teradata"} /%}
