...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/redshift/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Redshift", 
    selectServicePath: "/images/v1.11/connectors/redshift/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/redshift/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/redshift/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.11/connectors/database/redshift/reverse-metadata.md" /%}
{% /collateContent %}
