...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/domo-pipeline/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.11/connectors/domopipeline/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/domopipeline/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/domopipeline/service-connection.png",
} 
/%}
