...
{% partial file="/v1.11/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/wherescape/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.11/connectors/wherescape/select-service.png",
    addNewServicePath: "/images/v1.11/connectors/wherescape/add-new-service.png",
    serviceConnectionPath: "/images/v1.11/connectors/wherescape/service-connection.png",
} 
/%}
