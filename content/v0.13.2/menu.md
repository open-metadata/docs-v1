...
site_menu:
  ...
  - category: Quickstart / Local Docker Deployement / OSX
    url: /quick-start/local-deployment/osx
  - category: Quickstart / Local Docker Deployement / Linux
    url: /quick-start/local-deployment/linux
  - category: Quickstart / Local Docker Deployement / Windows
    url: /quick-start/local-deployment/windows

  - category: OpenMetadata
    url: /open-metadata/get-started
  - category: OpenMetadata / Get Started
    url: /open-metadata/get-started
