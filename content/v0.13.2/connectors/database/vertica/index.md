...
<TileContainer>
  ...
  <Tile
    ...
    link="/connectors/database/vertica/cli"
    size="half"
  />
</TileContainer>
...
Select Vertica as the service type and click Next.

<div className="w-100 flex justify-center">
<Image
  src="/images/openmetadata/connectors/vertica/select-service.png"
  alt="Select Service"
...
<div className="w-100 flex justify-center">
<Image
  src="/images/openmetadata/connectors/vertica/add-new-service.png"
  alt="Add New Service"
...
you've configured the connector to read from your vertica service as
desired.

<div className="w-100 flex justify-center">
<Image
  src="/images/openmetadata/connectors/vertica/service-connection.png"
