...
<TileContainer>
  ...
  <Tile
    ...
    link="/connectors/database/trino/cli"
    size="half"
  />
</TileContainer>
...
<Image
  src="/images/openmetadata/connectors/trino/select-service.png"
  alt="Select Service"
...
<div className="w-100 flex justify-center">
<Image
  src="/images/openmetadata/connectors/trino/add-new-service.png"
  alt="Add New Service"
...
you've configured the connector to read from your trino service as
desired.

<div className="w-100 flex justify-center">
<Image
  src="/images/openmetadata/connectors/trino/service-connection.png"
