...
<TileContainer>
  <Tile
    ...
    link="/connectors/database/databricks/airflow"
    size="half"
  />
  <Tile
    icon="account_tree"
    ...
    link="/connectors/database/databricks/cli"
    size="half"
  />
</TileContainer>
...
<Image
  src="/images/openmetadata/connectors/databricks/select-service.png"
  alt="Select Service"
...
you've configured the connector to read from your databricks service as
desired.

<div className="w-100 flex justify-center">
<Image
  src="/images/openmetadata/connectors/databricks/service-connection.png"
