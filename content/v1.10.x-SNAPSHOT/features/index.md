...
description: Discover OpenMetadata'spowerful features for data discovery, lineage tracking, governance, and collaboration. Explore comprehensive tools to manage you...
slug: /features
---
...
{% image
  src="/images/v1.10/features/all-your-data-in-one-place.gif"
/%}
...
{% image
  src="/images/v1.10/features/data-discovery-association.gif"
/%}
...
{% image
  src="/images/v1.10/features/data-discovery-advanced-search.gif"
/%}
...
{% image
  src="/images/v1.10/features/activity-feeds.gif"
/%}
...
{% image
  src="/images/v1.10/features/event-notification-slack.gif"
/%}
...
{% image
  src="/images/v1.10/features/complex-data-types.gif"
/%}
...
{% image
  src="/images/v1.10/features/deleted-entity.gif"
/%}
...
{% image
  src="/images/v1.10/features/importance-owners.gif"
/%}
...
{% image
  src="/images/v1.10/features/identify-asset-owner.gif"
/%}
...
{% image
  src="/images/v1.10/features/manual-lineage.gif"
/%}
...
{% image
  src="/images/v1.10/features/dbt-integration.gif"
/%}
...
{% image
  src="/images/v1.10/features/ingestion-pipelines.gif"
/%}
...
{% image
  src="/images/v1.10/features/data-versioning.gif"
/%}
