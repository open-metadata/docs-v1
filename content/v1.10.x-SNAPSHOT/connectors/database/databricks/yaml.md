...
{% partial file="/v1.10/connectors/yaml/query-usage.md" variables={connector: "databricks"} /%}

{% partial file="/v1.10/connectors/yaml/lineage.md" variables={connector: "databricks"} /%}

{% partial file="/v1.10/connectors/yaml/data-profiler.md" variables={connector: "databricks"} /%}

{% partial file="/v1.10/connectors/yaml/auto-classification.md" variables={connector: "databricks"} /%}
