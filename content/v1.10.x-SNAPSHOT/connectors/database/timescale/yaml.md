...
{% partial file="/v1.9/connectors/yaml/query-usage.md" variables={connector: "timescale"} /%}

{% partial file="/v1.9/connectors/yaml/lineage.md" variables={connector: "timescale"} /%}

{% partial file="/v1.9/connectors/yaml/data-profiler.md" variables={connector: "timescale"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.md" variables={connector: "timescale"} /%}
