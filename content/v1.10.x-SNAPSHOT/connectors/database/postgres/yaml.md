...
{% partial file="/v1.10/connectors/yaml/query-usage.md" variables={connector: "postgres"} /%}

{% partial file="/v1.10/connectors/yaml/lineage.md" variables={connector: "postgres"} /%}

{% partial file="/v1.10/connectors/yaml/data-profiler.md" variables={connector: "postgres"} /%}

{% partial file="/v1.10/connectors/yaml/auto-classification.md" variables={connector: "postgres"} /%}
