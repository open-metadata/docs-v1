...
{% image
  src="/images/v1.12/getting-started/add-ingestion0.png"
...
{% image
  src="/images/v1.12/getting-started/add-ingestion.png"
...
{% image
  src="/images/v1.12/getting-started/ingestion-config.png"
...
{% image
  src="/images/v1.12/getting-started/schedule-ingesgtion.png"
...
{% image
  src="/images/v1.12/getting-started/explore-tab.png"
  alt="Ingested Data"
...
{% image
src="/images/v1.12/how-to-guides/admin-guide/email.png"
...
{% image
  src="/images/v1.12/getting-started/users.png"
...
{% image
  src="/images/v1.12/getting-started/add-users.png"
  alt="Adding New User"
  height="750px"
...
{% image
  src="/images/v1.12/getting-started/update-user.png"
  alt="Users Profile"
