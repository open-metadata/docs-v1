...
{% image src="/images/v1.12/developers/custom-properties.png" alt="Custom property added to table" caption=" " /%}
...
{% image src="/images/v1.12/developers/delete-custom-properties.png" alt="Delete custom property added to table" caption=" " /%}
