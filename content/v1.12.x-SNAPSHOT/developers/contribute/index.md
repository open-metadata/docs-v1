...
{% image src="/images/v1.12/developers/contribute/github-issues.png" alt="GitHub issues" caption=" " /%}
...
{% image src="/images/v1.12/developers/contribute/fork-github-project.png" alt="Fork GitHub project" caption=" " /%}
...
{% image src="/images/v1.12/developers/contribute/open-pr.png" alt="Open a pull request" caption=" " /%}
3. If not, click on "New Pull request"
{% image src="/images/v1.12/developers/contribute/new-pr.png" alt="New Pull request" caption=" " /%}
4. Select your fork repository and branch
{% image src="/images/v1.12/developers/contribute/select-fork-branch.png" alt="Select your fork repository and branch" caption=" " /%}
