...
{% image src="/images/v1.12/deployment/security/okta/create-oidc-app-integration.png" alt="create-oidc-app-integration" /%}

- Click on **Applications -> Applications** in the left navigation panel.
{% image src="/images/v1.12/deployment/security/okta/click-applications.png" alt="click-applications" /%}

- Click on the **Create App Integration** button.
{% image src="/images/v1.12/deployment/security/okta/create-app-integration.png" alt="create-app-integration" /%}
...
{% image src="/images/v1.12/deployment/security/okta/configuring-the-app.png" alt="configuring-the-app" /%}
...
- Click **Save**.
{% image src="/images/v1.12/deployment/security/okta/general-settings-click-save.png" alt="general-settings-click-save" /%}

- The app is now configured.
{% image src="/images/v1.12/deployment/security/okta/app-is-configured.png" alt="app-is-configured" /%}
...
{% image src="/images/v1.12/deployment/security/okta/click-security-api.png" alt="click-security-api" /%}

- From the **Authorization Servers** tab, click on **Add Authorization Server** button.
{% image src="/images/v1.12/deployment/security/okta/click-add-authorization-server.png" alt="click-add-authorization-server" /%}
...
- **Save** the changes.
{% image src="/images/v1.12/deployment/security/okta/add-auth-server-save-changes.png" alt="add-auth-server-save-changes" /%}
...
{% image src="/images/v1.12/deployment/security/okta/default-server.png" alt="default-server" /%}
...
{% image src="/images/v1.12/deployment/security/okta/click-auth-server-from-prev-step.png" alt="click-auth-server-from-prev-step" /%}

The Issuer URL shows up as Dynamic by default. Change the Issuer URL to Okta URL and save the changes.
{% image src="/images/v1.12/deployment/security/okta/change-issuer-url.png" alt="change-issuer-url" /%}

### Step 6: Create a Default Scope
- To create a default scope from **Security -> API**, click on the required **Authorization Server**.
{% image src="/images/v1.12/deployment/security/okta/click-req-auth-server.png" alt="click-req-auth-server" /%}

- In the resulting page, click on the **Scopes** tab
- Click on **Add Scope**
{% image src="/images/v1.12/deployment/security/okta/add-scope.png" alt="add-scope" /%}

- Set as a **Default Scope**.
{% image src="/images/v1.12/deployment/security/okta/set-default-scope.png" alt="set-default-scope" /%}
...
{% image src="/images/v1.12/deployment/security/okta/add-new-access-policy.png" alt="add-new-access-policy" /%}

- To create a policy, add a Name and Description.
- Assign the policy to the required clients.
{% image src="/images/v1.12/deployment/security/okta/assign-policy.png" alt="" /%}
...
{% image src="/images/v1.12/deployment/security/okta/add-rule.png" alt="add-rule" /%}
...
{% image src="/images/v1.12/deployment/security/okta/see-your-application.png" alt="see-your-application" /%}
...
{% image src="/images/v1.12/deployment/security/okta/deselect-user-consent.png" alt="deselect-user-consent" /%}
...
{% image src="/images/v1.12/deployment/security/okta/click-edit-token.png" alt="click-edit-token" /%}
