...
{% image
  src="/images/v1.12/features/ingestion/workflows/profiler/custom-metric1.png"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/profiler/custom-metric2.png"
  alt="Input SQL query"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/profiler/custom-metric3.png"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/profiler/custom-metric4.png"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/profiler/column-metric2.png"
  alt="Run Profiler Agent"
  caption="Run Profiler Agent"
 /%}
...
{% image
  src="/images/v1.12/features/ingestion/workflows/profiler/column-metric3.png"
  alt="Run Profiler Agent"
  caption="Run Profiler Agent"
 /%}
...
{% image
  src="/images/v1.12/features/ingestion/workflows/profiler/column-metric4.png"
  alt="View Custom Metric"
  caption="View Custom Metric"
 /%}
