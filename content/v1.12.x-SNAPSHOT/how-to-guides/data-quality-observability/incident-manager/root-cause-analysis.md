...
{% image 
src="/images/v1.12/features/ingestion/workflows/data-quality/sample-row-failure-deletion.png"
...
{% image 
src="/images/v1.12/features/ingestion/workflows/data-quality/set_compute_row_count.png"
alt="set compute row count"
/%}

![test definition](/images/v1.12/features/ingestion/workflows/data-quality/failed_rows_sample_1.png)
![failed rows sampls](/images/v1.12/features/ingestion/workflows/data-quality/failed_rows_sample_2.png)
...
## Inspection Query
 ...
 ![inspection query](/images/v1.12/features/ingestion/workflows/data-quality/inspection-query.png)