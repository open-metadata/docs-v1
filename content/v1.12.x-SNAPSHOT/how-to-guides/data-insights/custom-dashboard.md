...
{% image
    src="/images/v1.12/features/data-insight/custom-dashboard/navigate-to-insights.png"
 ...
 {% image
    src="/images/v1.12/features/data-insight/custom-dashboard/add-dashboard.png"
    alt="Click on Add Dashboard"
    caption="Click on Add Dashboard"
 /%}

{% image
    src="/images/v1.12/features/data-insight/custom-dashboard/create-custom-dashboard-form.png"
...
{% image
    src="/images/v1.12/features/data-insight/custom-dashboard/create-chart.png"
    alt="Create Chart"
...
{% image
    src="/images/v1.12/features/data-insight/custom-dashboard/create-chart-form-1.png"
    alt="Create Chart Form Part 1"
    caption="Create Chart Form Part 1"
 /%}

 {% image
    src="/images/v1.12/features/data-insight/custom-dashboard/create-chart-form-2.png"
...
{% image
    src="/images/v1.12/features/data-insight/custom-dashboard/formula-breakdown.png"
...
{% image
    src="/images/v1.12/features/data-insight/custom-dashboard/create-chart-form-preview.png"
...
{% image
    src="/images/v1.12/features/data-insight/custom-dashboard/save-and-rearrange-chart.png"
