...
- {% collateContent %}Collate{% /collateContent %}{% ossContent %}OpenMetadata{% /ossContent %} [MCP Application and Personal Access Token](https://docs.open-metadata.org/v1.12.x/how-to-guides/mcp#installing-mcp-server)
...
{% ossContent %}
{% image
src="/images/v1.12/how-to-guides/mcp/goose-settings.jpg"
alt="Goose settings"
...
{% ossContent %}
{% image
src="/images/v1.12/how-to-guides/mcp/goose-mcp-settings.jpg"
...
{% ossContent %}
{% image
src="/images/v1.12/how-to-guides/mcp/goose-add-extension.jpg"
...
{% ossContent %}
{% image
src="/images/v1.12/how-to-guides/mcp/goose-success.jpg"
