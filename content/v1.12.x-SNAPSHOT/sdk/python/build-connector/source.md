...
{% image
src="/images/v1.12/sdk/python/build-connector/add-project-in-pycharm.png"
...
{% image
src="/images/v1.12/sdk/python/build-connector/select-interpreter.png"
alt="Select interpreter in pycharm"
 /%}

**Now apply and okay that interpreter**
{% image
src="/images/v1.12/sdk/python/build-connector/add-interpreter.png"
alt="Select interpreter in pycharm"
 /%}
