...
{% partial file="/v1.12/connectors/api/connectors-list.md" /%}

## Database / DataWarehouse Services

{% partial file="/v1.12/connectors/database/connectors-list.md" /%}

## Dashboard Services

{% partial file="/v1.12/connectors/dashboard/connectors-list.md" /%}

## Drive Services

{% partial file="/v1.12/connectors/drive/connectors-list.md" /%}

## Messaging Services

{% partial file="/v1.12/connectors/messaging/connectors-list.md" /%}

## Pipeline Services

{% partial file="/v1.12/connectors/pipeline/connectors-list.md" /%}

## ML Model Services

{% partial file="/v1.12/connectors/ml-model/connectors-list.md" /%}

## Storage Services

{% partial file="/v1.12/connectors/storage/connectors-list.md" /%}

## Metadata Services

{% partial file="/v1.12/connectors/metadata/connectors-list.md" /%}

## Security Services

{% partial file="/v1.12/connectors/security/connectors-list.md" /%}

## Search Services

{% partial file="/v1.12/connectors/search/connectors-list.md" /%}
