...
{% partial file="/v1.12/connectors/yaml/common/azure-config-def.md" /%}

{% partial file="/v1.12/connectors/yaml/storage/source-config-def.md" /%}
...
{% partial file="/v1.12/connectors/yaml/common/azure-config.md" /%}
...
{% partial file="/v1.12/connectors/yaml/storage/source-config.md" /%}
