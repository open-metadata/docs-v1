...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/storage/adls/yaml"} /%}
...
{% partial file="/v1.12/connectors/storage/manifest.md" /%}
...
{% image
src="/images/v1.12/connectors/visit-services-page.png"
...
{% image
src="/images/v1.12/connectors/create-new-service.png"
...
{% image
  src="/images/v1.12/connectors/adls/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.12/connectors/adls/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.12/connectors/adls/service-connection.png"
...
{% partial file="/v1.12/connectors/storage/configure-ingestion.md" /%}
