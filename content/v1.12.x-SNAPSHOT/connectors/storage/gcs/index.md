...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/storage/gcs/yaml"} /%}
...
{% image
  src="/images/v1.12/connectors/gcs/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.12/connectors/gcs/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.12/connectors/gcs/service-connection.png"
