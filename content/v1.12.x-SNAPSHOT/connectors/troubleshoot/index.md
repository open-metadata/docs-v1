...
{% image
  src="/images/v1.12/connectors/debug/debug1.png"
...
{% image
  src="/images/v1.12/connectors/debug/debug2.png"
...
{% image
  src="/images/v1.12/connectors/debug/debug3.png"
...
{% image
  src="/images/v1.12/connectors/debug/debug4.png"
...
{% image
src="/images/v1.12/connectors/datalake/troubleshoot-clientId.png"
...
{% image
src="/images/v1.12/connectors/azuresql/autocommit.png"
alt="autocommit" /%}
...
{% image
src="/images/v1.12/connectors/azuresql/azure-firewall.png"
...
{% image
src="/images/v1.12/connectors/databricks/select-sql-warehouse.png"
...
{% image
src="/images/v1.12/connectors/databricks/Open-sql-warehouse.png"
...
{% image
src="/images/v1.12/connectors/databricks/Connection-details.png"
...
{% image
src="/images/v1.12/connectors/databricks/Open-create-tocken-page.png"
...
{% image
src="/images/v1.12/connectors/databricks/Generate-token.png"
alt="Generate token"
...
{% image
src="/images/v1.12/connectors/domodatabase/client-id.png"
alt="Client-id"
...
{% image
src="/images/v1.12/connectors/domodatabase/access-token.png"
alt="Access Token"
...
{% image
src="/images/v1.12/connectors/domodatabase/scopes.jpeg"
alt="Scopes"
caption="Scopes" /%}
...
{% image
src="/images/v1.12/connectors/redshift/service-connection-arguments.png"
alt="Configure service connection"
...
{% image
src="/images/v1.12/connectors/unitycatalog/select-sql-warehouse.png"
alt="Select Sql Warehouse"
caption="Select Sql Warehouse" /%}
...
{% image
src="/images/v1.12/connectors/unitycatalog/Open-sql-warehouse.png"
alt="Open Sql Warehouse"
caption="Open Sql Warehouse" /%}
...
{% image
src="/images/v1.12/connectors/unitycatalog/Connection-details.png"
alt="Connection details"
caption="Connection details" /%}
...
{% image
src="/images/v1.12/connectors/unitycatalog/Open-create-token-page.png"
alt="Open create token"
caption="Open create token" /%}
...
{% image
src="/images/v1.12/connectors/unitycatalog/Generate-token.png"
alt="Generate token"
caption="Generate token" /%}
