...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/postgres/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.12/connectors/postgres/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/postgres/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/postgres/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.12/connectors/database/postgres/reverse-metadata.md" /%}
{% /collateContent %}
