...
{% partial file="/v1.12/connectors/yaml/data-profiler.md" variables={connector: "synapse"} /%}

{% partial file="/v1.12/connectors/yaml/auto-classification.md" variables={connector: "synapse"} /%}
