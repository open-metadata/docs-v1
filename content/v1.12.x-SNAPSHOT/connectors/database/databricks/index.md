...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/databricks/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.12/connectors/databricks/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/databricks/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/databricks/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.12/connectors/database/databricks/reverse-metadata.md" /%}
{% /collateContent %}
