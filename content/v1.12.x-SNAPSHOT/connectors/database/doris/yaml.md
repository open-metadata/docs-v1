...
{% partial file="/v1.12/connectors/yaml/data-profiler.md" variables={connector: "doris"} /%}

{% partial file="/v1.12/connectors/yaml/auto-classification.md" variables={connector: "doris"} /%}
