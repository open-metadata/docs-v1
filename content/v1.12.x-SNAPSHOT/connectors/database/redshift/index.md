...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/redshift/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.12/connectors/database/redshift/reverse-metadata.md" /%}
{% /collateContent %}
