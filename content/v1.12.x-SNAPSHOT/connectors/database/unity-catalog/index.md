...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/unity-catalog/yaml"} /%}
...
{% image
src="/images/v1.12/connectors/databricks/Open-create-token-page.png"
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.12/connectors/unitycatalog/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/unitycatalog/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/unitycatalog/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.12/connectors/database/unitycatalog/reverse-metadata.md" /%}
{% /collateContent %}
