...
{% partial file="/v1.12/connectors/yaml/query-usage.md" variables={connector: "unitycatalog"} /%}

{% partial file="/v1.12/connectors/yaml/lineage.md" variables={connector: "unitycatalog"} /%}
