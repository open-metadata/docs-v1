...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/epic/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Epic FHIR", 
    selectServicePath: "/images/v1.12/connectors/epic/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/epic/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/epic/service-connection.png",
} 
/%}
