...
{% partial file="/v1.12/connectors/yaml/lineage.md" variables={connector: "singlestore"} /%}

{% partial file="/v1.12/connectors/yaml/data-profiler.md" variables={connector: "singlestore"} /%}

{% partial file="/v1.12/connectors/yaml/auto-classification.md" variables={connector: "singlestore"} /%}
