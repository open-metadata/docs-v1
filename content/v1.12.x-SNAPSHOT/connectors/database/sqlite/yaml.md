...
{% partial file="/v1.12/connectors/yaml/data-profiler.md" variables={connector: "sqlite"} /%}

{% partial file="/v1.12/connectors/yaml/auto-classification.md" variables={connector: "sqlite"} /%}

{% partial file="/v1.12/connectors/yaml/data-quality.md" /%}

{% partial file="/v1.12/connectors/yaml/lineage.md" variables={connector: "sqlite"} /%}
