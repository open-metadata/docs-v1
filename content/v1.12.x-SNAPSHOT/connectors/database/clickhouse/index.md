...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/clickhouse/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.12/connectors/clickhouse/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/clickhouse/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/clickhouse/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.12/connectors/database/clickhouse/reverse-metadata.md" /%}
{% /collateContent %}
