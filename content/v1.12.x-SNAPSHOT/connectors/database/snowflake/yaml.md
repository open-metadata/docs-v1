...
{% partial file="/v1.12/connectors/yaml/query-usage.md" variables={connector: "snowflake"} /%}

{% partial file="/v1.12/connectors/yaml/lineage.md" variables={connector: "snowflake"} /%}

{% partial file="/v1.12/connectors/yaml/data-profiler.md" variables={connector: "snowflake"} /%}

{% partial file="/v1.12/connectors/yaml/auto-classification.md" variables={connector: "snowflake"} /%}
