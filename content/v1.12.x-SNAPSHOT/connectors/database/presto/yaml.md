...
{% partial file="/v1.12/connectors/yaml/data-profiler.md" variables={connector: "presto"} /%}

{% partial file="/v1.12/connectors/yaml/auto-classification.md" variables={connector: "presto"} /%}
