...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/pinotdb/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "PinotDB", 
    selectServicePath: "/images/v1.12/connectors/pinotdb/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/pinotdb/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/pinotdb/service-connection.png",
} 
/%}
