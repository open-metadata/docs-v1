...
{% partial file="/v1.12/connectors/yaml/common/gcp-config-def.md" /%}
...
{% partial file="/v1.12/connectors/yaml/common/gcp-config.md" /%}
...
{% partial file="/v1.12/connectors/yaml/query-usage.md" variables={connector: "bigquery"} /%}

{% partial file="/v1.12/connectors/yaml/lineage.md" variables={connector: "bigquery"} /%}

{% partial file="/v1.12/connectors/yaml/data-profiler.md" variables={connector: "bigquery"} /%}

{% partial file="/v1.12/connectors/yaml/auto-classification.md" variables={connector: "bigquery"} /%}
