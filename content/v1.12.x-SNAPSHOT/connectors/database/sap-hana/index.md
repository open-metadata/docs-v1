...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/sap-hana/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "SAP HANA", 
    selectServicePath: "/images/v1.12/connectors/sap-hana/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/sap-hana/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/sap-hana/service-connection.png",
} 
/%}
