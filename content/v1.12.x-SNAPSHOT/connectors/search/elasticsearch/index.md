...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/search/elasticsearch/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.12/connectors/elasticsearch/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/elasticsearch/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/elasticsearch/service-connection.png",
} 
/%}
...
{% partial file="/v1.12/connectors/search/configure-ingestion.md" /%}
