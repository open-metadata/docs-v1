...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/flink/yaml"} /%}
...
{% partial 
    ...
    variables={
        ...
        selectServicePath: "/images/v1.12/connectors/flink/select-new-service.webp",
        addNewServicePath: "/images/v1.12/connectors/flink/add-new-service.webp",
        serviceConnectionPath: "/images/v1.12/connectors/flink/service-connection.webp",
    } 
/%}
