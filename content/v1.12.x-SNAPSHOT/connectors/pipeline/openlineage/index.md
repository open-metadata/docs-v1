...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.12/connectors/openlineage/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/openlineage/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/openlineage/service-connection.png",
} 
/%}
...
openlineage_service_request = CreatePipelineServiceRequest(
    ...
    connection=PipelineConnection(
        config=OpenLineageConnection(
            ...
            # below ssl config in optional and used only when securityProtocol=KafkaSecurityProtocol.SSL
