...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/mode/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Mode", 
    selectServicePath: "/images/v1.12/connectors/mode/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/mode/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/mode/service-connection.png",
} 
/%}
