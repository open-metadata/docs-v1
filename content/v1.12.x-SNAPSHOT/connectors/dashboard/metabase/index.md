...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/metabase/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Metabase", 
    selectServicePath: "/images/v1.12/connectors/metabase/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/metabase/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/metabase/service-connection.png",
} 
/%}
