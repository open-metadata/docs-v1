...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/thoughtspot/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.12/connectors/thoughtspot/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/thoughtspot/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/thoughtspot/service-connection.png",
} 
/%}
