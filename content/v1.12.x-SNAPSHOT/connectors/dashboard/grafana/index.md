...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/grafana/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Grafana", 
    selectServicePath: "/images/v1.12/connectors/grafana/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/grafana/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/grafana/service-connection.png",
} 
/%}
