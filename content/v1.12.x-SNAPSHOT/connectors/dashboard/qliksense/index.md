...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/qliksense/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "QlikSense", 
    selectServicePath: "/images/v1.12/connectors/qliksense/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/qliksense/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/qliksense/service-connection.png",
} 
/%}
...
{% image
  src="/images/v1.12/connectors/ssl_qlik_1.png"
  alt="SSL Configuration by local file path"
  height="450px"
  caption="SSL Configuration by local file path" /%}

  {% image
  src="/images/v1.12/connectors/ssl_qlik_2.png"
