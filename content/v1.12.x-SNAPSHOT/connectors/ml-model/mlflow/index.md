...
{% partial file="/v1.12/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/ml-model/mlflow/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Mlflow", 
    selectServicePath: "/images/v1.12/connectors/mlflow/select-service.png",
    addNewServicePath: "/images/v1.12/connectors/mlflow/add-new-service.png",
    serviceConnectionPath: "/images/v1.12/connectors/mlflow/service-connection.png",
} 
/%}
