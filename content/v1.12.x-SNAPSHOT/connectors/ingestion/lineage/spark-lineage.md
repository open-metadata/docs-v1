...
Configure the OpenMetadata Spark Agent directly in your PySpark code:
...
{% image
  src="/images/v1.12/connectors/spark/spark-upload-jar.png"
...
{% image
  src="/images/v1.12/connectors/spark/spark-upload-jar-2.png"
  alt="Spark Upload Jar"
  caption="Spark Upload Jar"
 /%}
...
{% image
  src="/images/v1.12/connectors/spark/spark-uploaded-jar.png"
  alt="Spark Upload Jar"
  caption="Spark Upload Jar"
 /%}
...
{% image
  src="/images/v1.12/connectors/spark/prepare-script.png"
  alt="Prepare Script"
...
{% image
  src="/images/v1.12/connectors/spark/spark-init-script.png"
...
{% image
  src="/images/v1.12/connectors/spark/spark-config-set.png"
...
{% image
  src="/images/v1.12/connectors/spark/glue-job-jar.png"
...
{% image
  src="/images/v1.12/connectors/spark/glue-job-params.png"
