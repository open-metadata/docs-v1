...
{% partial file="/v1.12/connectors/yaml/dbt/dbt-prefix-def.md" /%}

{% partial file="/v1.12/connectors/yaml/dbt/source-config-def.md" /%}
...
{% partial file="/v1.12/connectors/yaml/dbt/dbt-prefix.md" /%}

{% partial file="/v1.12/connectors/yaml/dbt/source-config.md" /%}
