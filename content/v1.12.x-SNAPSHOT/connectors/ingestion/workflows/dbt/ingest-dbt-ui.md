...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/dbt-features/dbt-query.webp"
  alt="dbt"
  caption="dbt"
 /%}
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/add-ingestion.webp"
  alt="add-ingestion"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/aws-s3.webp"
  alt="aws-s3-bucket"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/gcp-bucket-form.webp"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/gcp-bucket-path.webp"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/azure-config.webp"
  alt="azure-bucket"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/local-storage.webp"
  alt="local-storage"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/file_server.webp"
  alt="file-server"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/dbt-cloud.webp"
  alt="dbt-cloud"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/schedule-and-deploy.webp"
