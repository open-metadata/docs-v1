...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/dbt-features/dbt-glossary-term.png"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/dbt-features/dbt-glossary-fqn.png"
  alt="Openmetadata_glossary_term"
  caption="OpenMetadata Glossary Term - term_one"
 /%}

{% image
  src="/images/v1.12/features/ingestion/workflows/dbt/dbt-features/dbt-glossary-nested-fqn.png"
  alt="Openmetadata_glossary_term"
