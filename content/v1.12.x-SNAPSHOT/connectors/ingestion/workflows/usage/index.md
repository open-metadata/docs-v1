...
{% image
  src="/images/v1.12/features/ingestion/workflows/usage/table-entity-page.png"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/usage/add-ingestion.png"
  alt="add-ingestion"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/usage/configure-usage-ingestion.png"
...
{% image
  src="/images/v1.12/features/ingestion/workflows/usage/scheule-and-deploy.png"
