...
{% image src="/images/v1.12/deployment/security/keycloak/keycloak-step-3.png" alt="add-client" /%}
...
{% image src="/images/v1.12/deployment/security/keycloak/keycloak-step-4.png" alt="compatibility configs" /%}

### Step 3: Add Login Settings
- fill the required options

{% image src="/images/v1.12/deployment/security/keycloak/keycloak-step-5.png" alt="edit-settings-url.png" /%}
...
{% image src="/images/v1.12/deployment/security/keycloak/keycloak-step-6.png" alt="client-credentials" /%}
