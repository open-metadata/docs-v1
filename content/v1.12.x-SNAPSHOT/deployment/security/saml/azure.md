...
{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-1.png" alt="EnterpriseApplications" /%}

- Click on `Enterprise Applications` and then ` + New Application ` .

{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-2.png" alt="new-application" /%}

- After that a new window will appear with different applications, click on `Create your own application`.

{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-3.png" alt="create-own-application" /%}
...
{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-4.png" alt="name-application-create" /%}

- Once you have the application created, open the app from list , and then click on `Single Sign-On` and then `SAML`.

{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-5.png" alt="saml-create-single-sign-On" /%}
...
{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-6.png" alt="edit-basic-saml-configuration" /%}

- Click on `Attributes and Claims` and click on the `Required Claim (NameId)`.

{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-7.png" alt="edit-claims" /%}
...
{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-8.png" alt="edit-claim-value" /%}
...
{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-9.png" alt="user-claim-value" /%}
...
{% image src="/images/v1.12/deployment/security/saml/azure/saml-azure-11.png" alt="verification-certificate" /%}
...
- Populate the above config from [xml metadata](/deployment/security/saml/xml_file)
 ...
 {% image src="/images/v1.12/deployment/security/saml/aws/saml-aws-8.png" alt="populate-metadata" /%}
