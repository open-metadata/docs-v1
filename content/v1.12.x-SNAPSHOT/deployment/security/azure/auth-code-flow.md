...
{% image src="/images/v1.12/deployment/security/azure/create-web-registration.png" alt="create-app" /%}
...
{% image src="/images/v1.12/deployment/security/azure/web-client-secret.png" alt="create-app" /%}
