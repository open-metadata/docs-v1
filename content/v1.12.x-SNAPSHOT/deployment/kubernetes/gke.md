...
{% image
  src="/images/v1.12/deployment/troubleshoot/dag-log.png"
  alt="dag-log" /%}
{% image
  src="/images/v1.12/deployment/troubleshoot/permission-pod-events.png"
...
{% partial file="/v1.12/deployment/faqs.md" /%}