...
{% image src="/images/v1.12/deployment/docker/om_docker_architecture.png" alt="Docker Deployment Architecture" /%}
...
{% partial file="/v1.12/deployment/configure-external-orchestrator-for-ingestion-service.md" /%}
...
```bash
wget https://github.com/open-metadata/OpenMetadata/releases/download/1.11.5-release/docker-compose-openmetadata.yml
```
...
{% partial file="/v1.12/deployment/postgresql-issue-permission-denied-extension-pgcrypto.md" /%}
