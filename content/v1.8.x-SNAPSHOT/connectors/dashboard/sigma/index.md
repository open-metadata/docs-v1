---
title: Sigma Connector for OpenMetadata | Documentation for Setup, Ingestion & Troubleshooting
...
{% partial file="/v1.8/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/sigma/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Sigma", 
    selectServicePath: "/images/v1.8/connectors/sigma/select-service.png",
    addNewServicePath: "/images/v1.8/connectors/sigma/add-new-service.png",
    serviceConnectionPath: "/images/v1.8/connectors/sigma/service-connection.png",
} 
/%}
