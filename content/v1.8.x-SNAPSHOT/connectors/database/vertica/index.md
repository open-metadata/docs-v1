...
{% partial file="/v1.8/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/vertica/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Vertica", 
    selectServicePath: "/images/v1.8/connectors/vertica/select-service.png",
    addNewServicePath: "/images/v1.8/connectors/vertica/add-new-service.png",
    serviceConnectionPath: "/images/v1.8/connectors/vertica/service-connection.png",
} 
/%}
