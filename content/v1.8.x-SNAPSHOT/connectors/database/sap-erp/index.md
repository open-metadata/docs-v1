...
{% partial file="/v1.8/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/sap-erp/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "SAP ERP", 
    selectServicePath: "/images/v1.8/connectors/sap-erp/select-service.png",
    addNewServicePath: "/images/v1.8/connectors/sap-erp/add-new-service.png",
    serviceConnectionPath: "/images/v1.8/connectors/sap-erp/service-connection.png",
} 
/%}
