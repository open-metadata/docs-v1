...
(e.g., [Athena](https://docs.open-metadata.org/latest/how-to-guides/data-insights/elasticsearch-reindex#2.-prepare-the-ingestion-dag)).
...
{% image
  src="/images/v1.10/connectors/credentials/airflow-connection.png"
