...
{% image src="/images/v1.10/deployment/security/azure/create-app-3.png" alt="create-app" /%}

### Step 2: Where to Find the Credentials

- The `Client ID` and the `Tenant ID` are displayed in the Overview section of the registered application.

{% image src="/images/v1.10/deployment/security/azure/client-id-and-authority.png" alt="create-app" /%}
