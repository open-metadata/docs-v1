...
{% image src="/images/v1.10/deployment/security/azure/create-app-1.png" alt="create-app" /%} 

- Click on `New Registration`. This step is for registering the OpenMetadata UI.

{% image src="/images/v1.10/deployment/security/azure/create-app-2.png" alt="create-app" /%}
