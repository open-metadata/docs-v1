...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/dagster/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Dagster", 
    selectServicePath: "/images/v1.10/connectors/dagster/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/dagster/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/dagster/service-connection.png",
} 
/%}
