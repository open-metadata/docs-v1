...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/airbyte/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Airbyte", 
    selectServicePath: "/images/v1.10/connectors/airbyte/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/airbyte/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/airbyte/service-connection.png",
} 
/%}
