...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/databricks-pipeline/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.10/connectors/databrickspipeline/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/databrickspipeline/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/databrickspipeline/service-connection.png",
} 
/%}
