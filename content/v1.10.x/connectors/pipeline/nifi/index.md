...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/pipeline/nifi/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Nifi", 
    selectServicePath: "/images/v1.10/connectors/nifi/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/nifi/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/nifi/service-connection.png",
} 
/%}
