...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/powerbi/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "PowerBI", 
    selectServicePath: "/images/v1.10/connectors/powerbi/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/powerbi/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/powerbi/service-connection.png",
} 
/%}
