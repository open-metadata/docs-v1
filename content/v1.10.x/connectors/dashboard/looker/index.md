...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/looker/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Looker", 
    selectServicePath: "/images/v1.10/connectors/looker/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/looker/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/looker/service-connection.png",
} 
/%}
