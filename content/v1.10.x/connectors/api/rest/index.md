...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/api/rest/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "VertexAI", 
    selectServicePath: "/images/v1.10/connectors/rest/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/rest/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/rest/service-connection.png",
} 
/%}
