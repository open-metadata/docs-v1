...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/storage/s3/yaml"} /%}
...
{% image
  src="/images/v1.10/connectors/s3/select-service.png"
  alt="Select Service"
...
{% image
  src="/images/v1.10/connectors/s3/add-new-service.png"
  alt="Add New Service"
...
{% image
  src="/images/v1.10/connectors/s3/service-connection.png"
...
{% partial file="/v1.10/connectors/storage/configure-ingestion.md" /%}
