...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/greenplum/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Teradata", 
    selectServicePath: "/images/v1.10/connectors/teradata/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/teradata/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/teradata/service-connection.png",
} 
/%}
