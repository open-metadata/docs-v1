...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/exasol/yaml"} /%}
...
{% partial
  ...
  variables={
    connector: "Exasol",
    selectServicePath: "/images/v1.10/connectors/exasol/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/exasol/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/exasol/service-connection.png",
  }
/%}
