...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/mssql/yaml"} /%}
...
{% image
src="/images/v1.10/connectors/mssql/remote-connection.png"
...
{% partial 
  ...
  variables={
    connector: "MSSQL", 
    selectServicePath: "/images/v1.10/connectors/mssql/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/mssql/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/mssql/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.10/connectors/database/mssql/reverse-metadata.md" /%}
{% /collateContent %}
