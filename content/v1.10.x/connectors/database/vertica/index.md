...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/vertica/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Vertica", 
    selectServicePath: "/images/v1.10/connectors/vertica/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/vertica/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/vertica/service-connection.png",
} 
/%}
