...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/ssas/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "SSAS", 
    selectServicePath: "/images/v1.10/connectors/ssas/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/ssas/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/ssas/service-connection.png",
} 
/%}
