...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/db2/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "DB2", 
    selectServicePath: "/images/v1.10/connectors/db2/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/db2/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/db2/service-connection.png",
} 
/%}
