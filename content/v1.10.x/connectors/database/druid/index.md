...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/athena/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Druid", 
    selectServicePath: "/images/v1.10/connectors/druid/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/druid/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/druid/service-connection.png",
} 
/%}
