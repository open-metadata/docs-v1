...
{% partial file="/v1.10/connectors/yaml/query-usage.md" variables={connector: "snowflake"} /%}

{% partial file="/v1.10/connectors/yaml/lineage.md" variables={connector: "snowflake"} /%}

{% partial file="/v1.10/connectors/yaml/data-profiler.md" variables={connector: "snowflake"} /%}
