...
{% partial file="/v1.10/connectors/yaml/lineage.md" variables={connector: "trino"} /%}

{% partial file="/v1.10/connectors/yaml/data-profiler.md" variables={connector: "trino"} /%}

{% partial file="/v1.10/connectors/yaml/auto-classification.md" variables={connector: "trino"} /%}
