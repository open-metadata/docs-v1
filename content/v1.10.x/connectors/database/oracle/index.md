...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/oracle/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Oracle", 
    selectServicePath: "/images/v1.10/connectors/oracle/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/oracle/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/oracle/service-connection.png",
} 
/%}
...
{% collateContent %}
{% partial file="/v1.10/connectors/database/oracle/reverse-metadata.md" /%}
{% /collateContent %}
