...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/presto/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Presto", 
    selectServicePath: "/images/v1.10/connectors/presto/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/presto/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/presto/service-connection.png",
} 
/%}
