...
{% partial file="/v1.10/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/database/couchbase/yaml"} /%}
...
{% partial 
  ...
  variables={
    connector: "Couchbase", 
    selectServicePath: "/images/v1.10/connectors/couchbase/select-service.png",
    addNewServicePath: "/images/v1.10/connectors/couchbase/add-new-service.png",
    serviceConnectionPath: "/images/v1.10/connectors/couchbase/service-connection.png",
} 
/%}
