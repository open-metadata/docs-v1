...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/alerts-menu.png"
  alt="Alerts Menu"
  caption="Alerts Menu"
 /%}
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/alert-source-selection.png"
  alt="Alerts Menu"
  caption="Alerts Menu"
 /%}
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/alerts-filter.png"
  alt="Alerts Menu"
  caption="Alerts Menu"
 /%}
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/alerts-trigger.png"
  alt="Alerts Menu"
  caption="Alerts Menu"
 /%}
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/alerts-destination.png"
  alt="Alerts Menu"
  caption="Alerts Menu"
 /%}