...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/profiler-summary-table.png"
  alt="Table profile summary page"
  caption="Table profile summary page"
 /%}

{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/profiler-summary-column.png"
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/add-profiler-workflow.png"
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/configure-profiler-workflow.png"
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/accessing-table-profile-settings.png"
  alt="table profile settings"
  caption="table profile settings"
 /%}

{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/table-profile-summary-view.png"
  alt="table profile settings"
  caption="table profile settings"
 /%}
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/profiler-global-configuration.png"
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/disable-metric-computation.png"
  alt="table profile global settings"
  caption="table profile global settings"
 /%}
...
{% image
  src="/images/v1.10/features/ingestion/workflows/profiler/disable-specific-metric-computation.png"
  alt="table profile global settings"
  caption="table profile global settings"
 /%}
