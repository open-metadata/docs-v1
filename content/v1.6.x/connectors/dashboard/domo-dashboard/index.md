...
{% partial file="/v1.6/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/dashboard/domo-dashboard/yaml"} /%}
...
{% partial 
  ...
  variables={
    ...
    selectServicePath: "/images/v1.6/connectors/domodashboard/select-service.png",
    addNewServicePath: "/images/v1.6/connectors/domodashboard/add-new-service.png",
    serviceConnectionPath: "/images/v1.6/connectors/domodashboard/service-connection.png",
} 
/%}
