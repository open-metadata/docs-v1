...
{% image
src={"/images/v1.6/features/integrations/ge-checkpoint-file.gif"}
...
{% image
src="/images/v1.6/features/integrations/ge-config-yaml.gif"
...
{% image
src="/images/v1.6/features/integrations/ge-run-checkpoint.gif"
